  ...
  profiles: [
    {
      ...
      condition: (ps, _avg) => ps[0] >= 3 && ps[2] >= 3,
    ...
    },
    {
      ...
      condition: (ps, _avg) => ps[0] >= 3 && ps[1] >= 3,
    ...
    },
    {
      ...
      condition: (ps, _avg) => ps[1] >= 3 && ps[2] >= 3,
